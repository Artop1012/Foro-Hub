...
import com.alura.challenge.ForoHub.domain.respuesta.*;
...
public class RespuestaController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<DatosRetornoRespuesta> registrarRespuesta(@RequestBody @Valid DatosRegistroRespuesta datosRegistroRespuesta,
